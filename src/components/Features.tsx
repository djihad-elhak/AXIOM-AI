  ...
  return (
    <div 
      ...
      className={cn(
        ...
        "lg:hover:bg-gradient-to-br lg:hover:from-white lg:hover:to-axiom-50",
        "transition-all duration-300"
      )}
      style={{ animationDelay: `${0.1 * index}s` }}
    >
      <div className="rounded-full bg-axiom-50 w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center text-axiom-500 mb-4 sm:mb-5">
        {icon}
      </div>
    ...
    <section className="py-12 sm:py-16 md:py-20 pb-0 relative bg-gray-50" id="features" ref={sectionRef}>
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          <div className="axiom-chip mx-auto mb-3 sm:mb-4 opacity-0 fade-in-element">
            <span>Features</span>
          </div>
